...
const Produtos = () => {
    return (
        <section className='py-5'>
            <div className="flex cards mt-20 max-w-screen-xl mx-auto items-center w-full bg-white rounded-[30px] h-[32vh]">
            ...
            <div className="flex cards mt-20 max-w-screen-xl mx-auto items-center w-full bg-white rounded-[30px] h-[32vh]">
                ...
                <div className='w-[45%] h-[80%] flex flex-col justify-between ml-[15%] '>
                    ...
                    <div className='flex justify-between items-center ml-[50%]'>
                        ...
                        <p className='line-through text-2xl font-medium '>$48.99</p>
                    </div>
                </div>
            ...
            <div className="flex cards mt-20 max-w-screen-xl mx-auto items-center w-full bg-white rounded-[30px] h-[32vh]">
                <div className='w-[45%] h-[80%] flex flex-col justify-between ml-10'>
                    ...
                    <div className='flex  w-[50%] justify-between items-center'>
                        <p className='line-through text-2xl font-medium '>$39.99</p>
